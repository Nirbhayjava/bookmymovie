...
<!-- Mirrored from askbootstrap.com/preview/movbok/movies-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Mar 2023 07:33:08 GMT -->
<head>
<meta charset="utf-8">
...
.time:hover{
 ...
 #preloader {
	...
	right:0;
	bottom:0;
	background-color:#e5eff1;/* change if the mask should be a color other than white */
...
#status {
	...
	background-image:url('https://i.gifer.com/origin/d3/d3f472b06590a25cb4372ff289d81711_w200.gif'); /* path to your loading animation */
...
//          console.log(localStorage.getItem("myarray"));
              ans+="<img src="+obj.photo+" class=\"img-fluid rounded\" alt=\"...\">";
ans+="<h1 class=\"h6 mb-0 mt-3 font-weight-bold text-gray-900\">Director</h1>";
ans+="<p>"+obj.director+"</p>";
ans+="<h1 class=\"h6 mb-0 mt-3 font-weight-bold text-gray-900\">Writers</h1>";
ans+="<p>"+obj.writers+"</p>";
ans+="<h1 class=\"h6 mb-0 mt-3 font-weight-bold text-gray-900\">Cast</h1>";
ans+="<p>"+obj.cast+"</p>";
ans+="<h1 class=\"h6 mb-0 mt-3 font-weight-bold text-gray-900\">Plot</h1>";
ans+="<p class=\"mb-0\">"+obj.plot+"</p>";

ans1+="<div>";
ans1+="<h3 class=\"mb-0 mt-0 font-weight-bold\">"+obj.moviename+"</small></h3>";
ans1+="<p class=\"mb-0 text-gray-800\"><small class=\"text-muted\"><i class=\"fas fa-film fa-fw fa-sm mr-1\"></i>"+obj.genre+" "+"/"+obj.language+"</small></p>";
ans1+="</div>";
ans1+="<div>";
ans1+="<a href=\"#\" class=\"d-sm-inline-block btn btn-primary shadow-sm-sm\"><i class=\"fas fa-share-alt\"></i></a>";
ans1+="<a href=\"#\" class=\"d-sm-inline-block btn btn-danger shadow-sm-sm\"> Add to Watchlist <i class=\"fas fa-plus fa-sm  ml-1\"></i></a>";
ans1+="</div>";

ans3+="<iframe width=\"800\" height=\"300\" src="+obj.trailer+"></iframe>";
          document.getElementById("banner").src = obj.banner;   
//         document.getElementById("title").innerHTML = obj.moviename;
//         document.getElementById("desc").innerHTML = obj.description;
            }
         
          document.getElementById("mycast").innerHTML = ans;
          document.getElementById("mymovie").innerHTML = ans1;
          document.getElementById("trailer").innerHTML = ans3;
    }
  };
  xhttp.open("POST", "../viewmoviebyid?id=<%=id%>", true);
  xhttp.send();
}
    function viewshows()
{
...
//        alert(this.response);
         ...
         for(var i=0; i<ar.length; i++)
         {
             var obj = ar[i];
               ...
               ans+="<h3 class=\"mt-0 mb-3\" id=\"name"+[i]+"\">"+obj.name+"</h3>";
               ans+="<a href=\"seatalloat.jsp?id="+obj.screens+"&show_id="+obj.id+"\"><span class=\"time\">"+obj.time+"</span></a>";                 
            
            }         
          document.getElementById("home").innerHTML = ans;
    }
  };
  xhttp.open("POST", "../viewshowbyid?id=<%=id%>", true);
  xhttp.send();
}
</script>
</head>
<body onload="viewmovie(),viewshows()">
     <div id="preloader">
	<div id="status">&nbsp;</div>
</div>
<nav class="navbar navbar-expand navbar-dark topbar static-top shadow-sm-sm bg-dark osahan-nav-top">
<div class="container">
...
<div class="dropdown-menu dropdown-menu-right p-3 shadow-sm-sm animated--grow-in" aria-labelledby="searchDropdown">
...
<div class="dropdown-list dropdown-menu dropdown-menu-right shadow-sm-sm animated--grow-in" aria-labelledby="alertsDropdown">
...
<div class="dropdown-menu dropdown-menu-right shadow-sm-sm animated--grow-in" aria-labelledby="userDropdown">
...
<div class="row">
<div class="col-lg-12">
<div class="position-absolute bg-white shadow-sm-sm rounded text-center p-2 mt-4 love-box">
...
<img src="img/cover3.jpg" id="banner" class="img-fluid" alt="...">
</div>
<div class="container">
<div class="row mb-4 pb-2 list-bp">
<div class="col-xl-3 col-lg-3">
<div class="bg-white p-3 widget shadow-sm rounded mb-4" id="mycast">
...
<div class="d-flex align-items-center justify-content-between p-3 border-bottom" id="mymovie">
<div>
<h3 class="mb-0 mt-0 font-weight-bold" id="title">The Fate of the Furious <small>2019</small></h3>
...
<div>
<a href="#" class="d-sm-inline-block btn btn-primary shadow-sm-sm"><i class="fas fa-share-alt"></i></a>
<a href="#" class="d-sm-inline-block btn btn-danger shadow-sm-sm"> Add to Watchlist <i class="fas fa-plus fa-sm  ml-1"></i></a>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Available Multiplex</a>
</li>
</ul>
<div class="tab-content" id="myTabContent">
<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
<h6 class="mt-0 mb-3" id="name0">New Year's Eve on the Waterfront</h6>
...
<div class="small text-gray-600">Acting</div>
</div>
</a>
</div>
<div class="artist-list mb-3">
...
<script src="vendor/jquery/jquery.min.js" type="684fc6c65c94a8e04c376529-text/javascript"></script>
<script src="vendor/bootstrap/js/bootstrap.bundle.min.js" type="684fc6c65c94a8e04c376529-text/javascript"></script>

<script type="684fc6c65c94a8e04c376529-text/javascript" src="vendor/slick/slick.min.js"></script>

<script src="js/osahan.js" type="684fc6c65c94a8e04c376529-text/javascript"></script>
<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="684fc6c65c94a8e04c376529-|49" defer=""></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"7a9bc85e7e629b98","version":"2023.2.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","si":100}' crossorigin="anonymous"></script>
