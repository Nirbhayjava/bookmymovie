...
ans1+="<a href=\"booking.jsp?id="+obj.id+"\" class=\"d-sm-inline-block btn btn-danger shadow-sm-sm\"> Book Now <i class=\"fas fa-plus fa-sm  ml-1\"></i></a>";
ans1+="</div>";
...
<div>
<h3 class="mb-0 mt-0 font-weight-bold">The Fate of the Furious <small>2019</small></h3>
...
<h6 class="mt-0 mb-3" id="title">New Year's Eve on the Waterfront</h6>
...
<div class="mt-0 mb-1">
<span class="h6 mr-2 font-weight-bold text-gray-900">Stave Martin</span> <span><i class="fa fa-calendar"></i> Feb 12, 2018</span>
