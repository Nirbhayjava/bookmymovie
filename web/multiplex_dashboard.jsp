<%-- 
    Document   : multiplex_dashboard
    Created on : 03-Mar-2023, 4:01:55 pm
    Author     : macbookair
--%>
...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="/BookmyMovie/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/BookmyMovie/js/demo/chart-area-demo.js"></script>
    <script src="/BookmyMovie/js/demo/chart-pie-demo.js"></script>
